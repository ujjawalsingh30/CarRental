...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Car" subTitle="Fill in details to list a new for booking,
      ...
      text-sm mt-6 maxx-w-xl'>
        ...
        <button className='flex items-center gap-2 px-4 py-2.5 mt-4 bg-primary
          ...
          <img src={assets.tick_icon} alt="" /> {isLoading ? 'Listing...' : 'List Your Car'} </button>
