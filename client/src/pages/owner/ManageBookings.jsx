...
const ManageBookings = () => {
  ...
  const fetchOwnerBookings = async () => {
    try {
      ...
      // data.success ? setBookings(data.bokkings) : toast.error(data.message)
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      ...
      <Title title="Manage Bookings" subTitle="Tract all customer bookingd, approve
      or cancle requests, and manage bookings statuses." />
            ...
            {bookings.map((booking, index) => (
              <tr key={index} className='border-t border-borderColor text-gray-500'>
                ...
                <td className='p-3 flex items-center gap-3'>
                  ...
                  <p className='font-medium max-md:hidden'>{booking.car.brand}</p>
                </td>
